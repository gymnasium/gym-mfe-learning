...
// import { GymHeader as Header } from '@edx/frontend-component-header';
...
const CourseAccessErrorPage = ({ intl }) => {
  ...
  return (
    <>
      {/* <Header /> */}
      <div id="main-content" className="main-content container my-5 text-center" data-testid="access-denied-main">
        <AlertList
          topic="outline"
          className="mx-5 mt-3"
          customAlerts={{
